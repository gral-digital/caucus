...
class Settings(BaseSettings):
    ...
    storage_bucket_documents: str = "caucus-documents"
    storage_bucket_sources: str = "caucus-sources"
    ...
    # Ingestion
    normattiva_user_agent: str = "CaucusBot/0.1 (+https://github.com/caucus-legal)"
